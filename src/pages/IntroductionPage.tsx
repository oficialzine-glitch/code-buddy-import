...
import phoneMockupImage from "../assets/Untitled design.png";
    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-slate-950 to-black relative overflow-hidden flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-between px-6 py-12">
        ...
        <div className="flex-1 flex items-center justify-center relative z-10">
          <img src={phoneMockupImage} alt="NextFace AI phone mockup" className="w-56 h-auto shadow-2xl" />
        </div>

        {/* Text content */}
        <div className="text-center max-w-sm mb-8 relative z-10">
          <h1 className="text-2xl font-bold text-white mb-6 leading-tight">Upload a photo, get your AI analysis</h1>
        </div>
